...
<nav class="w3-sidebar w3-bar-block w3-white w3-collapse w3-top" style="z-index:3;width:250px" id="mySidebar">
  ...
  <div class="w3-padding-64 w3-large w3-text-grey" style="font-weight:bold">
    ...
    <div id="demoAcc" class="w3-bar-block w3-hide w3-padding-large w3-medium">
      ...
      <a href="/introduction/functions.php" class="w3-bar-item w3-button">PHP Functions</a>
    ...
    <div id="demoAcc1" class="w3-bar-block w3-hide w3-padding-large w3-medium">
        ...
        <a href="/advanced/include.php" class="w3-bar-item w3-button">PHP Include</a>
        <a href="/advanced/handle.php" class="w3-bar-item w3-button">PHP File Handling</a>
        <a href="/advanced/open.php" class="w3-bar-item w3-button w3-light-grey ">PHP File Open/Read/Close</a>
...
<div class="w3-main" style="margin-left:250px">
  ...
  <header class="w3-container w3-xlarge">
    <p class="w3-left">PHP File Open/Read/Close</p>
    <p class="w3-right">
  ...
  <div class="w3-row w3-grayscale">
    <div class="w3-col l3 s6">
      <div class="w3-container">
        <img src="/snips/open.png" style="width:300%">
        <p>Code<br></p>
      </div>
      <div class="w3-container">
      <?php
//PHP FILE OPEN/READ/CLOSE
$myfile = fopen("verse.txt", "r") or die("Unable to open file!");
echo fread($myfile,filesize("verse.txt"));
fclose($myfile);
?>
        <p>Output<br></p>
      </div>
